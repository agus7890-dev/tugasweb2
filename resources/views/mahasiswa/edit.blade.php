                        ...
                        <div class="form-group">
                            <div class="form-row">                                   
                                 ...
                                 <label for="">TANGGAL LAHIR</label>
                                    <input type="date" name="tanggal_lahir" class="form-control" placeholder="Masukkan Tanggal" value="{{ is_null
                                 ...
                                 <div class="col">
                                    ...
                                    <input type="number" name="telepon" class="form-control" placeholder="Masukkan Nomor Telepon" value="{{ is_null
